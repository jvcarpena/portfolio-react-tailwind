...
function Skills() {
  return (
    <section
      id="skills"
      className="mx-auto max-w-7xl my-12 min-h-[calc(100vh-68px)] scroll-mt-20 p-6 [&@media(max-aspect-ratio:1/1)]:aspect-[13/20]"
    >
      <h2 className="mb-8 text-4xl bg-linear-to-r from-white to-slate-900 bg-clip-text text-transparent font-bold sm:mb-10 sm:text-5xl">
        SKILLS
      </h2>
      <p className="text-xl sm:text-2xl mb-8 sm:mb-12">
        Leveraging modern technologies and robust open-source tools, I develop
        efficient, user-friendly applications and websites designed for seamless
